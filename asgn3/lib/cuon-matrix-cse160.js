...
class Vector3 {
    ...
    static dot(other1, other2) {
        ...
        let d = sum; // Modify this line to calculate this vector's magnitude.
    ...
    static cross(other1, other2) {
        ...
        v[0] = (o1[1]*o2[2]) - (o1[2]*o2[1]);
        v[1] = (o1[2]*o2[0]) - (o1[0]*o2[2]);
        v[2] = (o1[0]*o2[1]) - (o1[1]*o2[0]);


        let v3 = new Vector3(v); // Modify this line to calculate cross product between other1 and other2.
    ...
    magnitude() {
        ...
        let m = Math.sqrt((v[0]*v[0]) + (v[1]*v[1]) + (v[2]*v[2])); // Modify this line to calculate this vector's magnitude.
